...
poblacion_provincias = poblacion_provincia * (23 // len(poblacion_provincia)) + poblacion_provincia[:23 % len(poblacion_provincia)]
...
print(tasa_homicidios_provincia())


# def distribucion_edad():
#     distribucion_edad = df['Edad'].value_counts().to_dict()
#     distribucion_edad = {edad: frecuencia for edad, frecuencia in distribucion_edad.items() if edad >= 13}
